...
const Banner = () => {
  ...
  return (
    <div className="mb-0 max-w-[1290px] mx-auto ">
      <div className="   mt-8  flex flex-col md:flex-row justify-between  py-24 items-center">
        <div className="md:w-[45%] md:mb-0 mb-5">
          <div className="sm:text-3xl text-2xl md:text-5xl   bg-gradient-to-r from-[#FF2E2E] to-[#f12735dc] bg-clip-text text-transparent font-extrabold font-BBH  h-[154px] ">
           Upgrade Your Skills & Conquer the Tech World
          </div>
          <div className="mt-4 text-xl font-roboto  text-[#1F2937] font-bold">
          ...
          <div className="mt-4 text-2xl font-roboto text-justify text-[#FF2E2E] font-bold">
            Learn | Work | Succeed
          </div>
          <div className="mt-12 text-xl font-nunito flex items-center  gap-3">
            <button className="px-3 py-2 rounded-2xl text-lg font-bold bg-[#FF2E2E] hover:bg-[#1F2937] text-[#ffffff]">
              Browse Course
            </button>
            <button className="px-3 py-2 rounded-2xl text-lg font-bold bg-[#1F2937]  hover:bg-[#FF2E2E] text-[#ffffff]">
              Join Free Seminar
            </button>
          </div>
        </div>
